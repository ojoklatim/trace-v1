...
async function onRequestPost2(context) {
  const { env } = context;
  if (env.STATE) {
    await env.STATE.put("rainfall_spiked", "true", { expirationTtl: 300 });
  }
  return new Response(JSON.stringify({
...
// ../.wrangler/tmp/pages-XfN9tO/functionsRoutes-0.9639452497182273.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-89H8vp/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-89H8vp/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9732553912100328.mjs.map
